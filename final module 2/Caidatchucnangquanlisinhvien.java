...
class Student extends Person {
    ...
    public void display(String batchName) {
        System.out.printf("%-6d | %-50s | %-10s | %-8s | %-20s%n", studentId, name, dateOfBirth, gender, batchId);
    }
    @Override
    public void display() {
...
public class Caidatchucnangquanlisinhvien {
    ...
    private static void addNewStudent(Scanner sc) {
        ...
        while (true) {
            ...
            if (phone.isEmpty() || !isValidPhone(phone)) {
                System.out.println("Số điện thoại lỗi");
                continue;
            }
    ...
    private static void searchStudent(Scanner sc) {
        ...
        System.out.println("\nKết quả tìm kiếm:");
        System.out.printf("Mã SV", "Tên sinh viên", "Ngày sinh", "Giới tính", "Điện thoại", "Mã lớp");
        for (Student s : students) {
    ...
    private static void viewTeacher(Scanner sc) {
        ...
        if (t != null) {
            System.out.println("\nThông tin giáo viên:");
            System.out.printf( "Mã GV", "Tên giáo viên", "Ngày sinh", "Giới tính", "Điện thoại");
            t.display();
        } else {
